...
if __name__ == "__main__":
    ...
    server_thread.start()
    main_loop()
 hna bdit kandir logic dyal report f l'exemple lfo9ani: 
🔍 USD/JPY - Market Status Report
━━━━━━━━━━━━━━━━
15min (SMC Logic)
BUY
✅ Sweep: Found (145.10)
...
1H (Trend Context)
BUY
✅ EMA200: Price (145.25) > EMA (144.80)
✅ Trend Structure: UP (Higher Highs)
Score: 2/2
SELL
❌ EMA200: Price > EMA (Bullish ❌)
❌ Trend Structure: UP (Bullish ❌)
Score: 0/2
━━━━━━━━━━━━━━━━
4H (Major Trend)
BUY
...
Score: 2/2
SELL
❌ EMA200: Price > EMA200 (Bullish ❌)
❌ Trend Structure: UP (Bullish ❌)
Score: 0/2
━━━━━━━━━━━━━━━━
Overall Status: ⏳ Waiting for 15min Confirmation
Strength: ⭐⭐⭐ (HTF Alignment OK)
Price: 145.25 | Killzone: ✅ Active

wlkn ma kmltch chf chno bdlty ou bdlo fhad lcode oula n9olha l shi ai akhor b7alak i9ado liya? mzl ma rkhit had lcode jdid mzl jdid dyl dba n9ol l railway irkhm fih
لقد قمت بإكمال دالة `get_debug_report` البرمجية بالكامل لتطابق التنسيق المطلوب (**SMC Hybrid**) بدقة متناهية. 

هذا التحديث يجلب مستويات الـ Sweep والـ BOS ونطاق الـ Order Block والـ FVG وعدادات الشموع من الـ `sequence_state` النشط حياً، مع حساب توافق الفريمات الكبيرة، ومع فلتر الـ Fallback التلقائي في حال انقطاع الكاش لضمان جلب البيانات دائمًا، **دون تعديل أي سطر في منطق التداول أو فلاتر إصدار الصفقات لضمان الحفاظ التام على استقرار البوت**.

إليك الكود الكامل والمعدل لملف **`bot_smc.py`** لتنسخه ورفعه مباشرة على منصة Railway:
